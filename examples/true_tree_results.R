...
bias_tree <- read.csv("true_tree_results_bias.csv", header = FALSE)
coverage_tree <- read.csv("true_tree_results_coverage.csv", header = FALSE)
brier_tree <- read.csv("true_tree_results_brier.csv", header = FALSE)

bart <- read.csv("../competingmethods/BART/true_tree/barts.csv") %>%
  mutate(method = "bart")
